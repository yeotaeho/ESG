...
public class SignupController {
    ...
    public ResponseEntity<Map<String, Object>> oauthSignup(@RequestBody Map<String, String> body) {
        ...
        try {
            ...
            // JWT 토큰 생성
            String accessToken = jwtTokenUtil.generateToken(user.getId(), provider, email);
            String refreshToken = jwtTokenUtil.generateRefreshToken(user.getId(), provider, email);
