    ...
    return (
        <div className="min-h-screen bg-white flex items-center justify-center px-4 py-24">
            <div className="w-full max-w-3xl">
                ...
                {/* Sign Up Button */}
                <Link href="/my_project/signup" className="block w-full border-2 border-black text-black py-4 rounded-md font-medium text-center hover:bg-gray-50 transition text-lg">
                    회원가입
                </Link>
            </div>
        </div>
