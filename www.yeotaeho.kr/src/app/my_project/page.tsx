...
import { getToken, getUserName, removeToken } from '@/utils/tokenStorage';
...
export default function App() {
    ...
    const handleLogout = () => {
        removeToken();
        logoutStore(); // Zustand store에서도 로그아웃
        setIsAuthenticated(false);
        setUserName(null);
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex justify-between items-center">
                ...
                <div className="flex items-center space-x-4">
                    ...
                    {isAuthenticated ? (
                        ...
                        <div className="hidden lg:flex items-center space-x-3">
                            <Link href="/my_project/login" className="px-4 py-2 text-sm text-gray-700 hover:text-red-600 transition font-medium">
                                로그인
                            </Link>
                            <Link href="/my_project/signup" className="px-4 py-2 text-sm text-white bg-red-600 hover:bg-red-700 transition font-medium rounded-full">
                                회원가입
                            </Link>
                        </div>
                    )}
